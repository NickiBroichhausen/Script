...
set tTransfer to getPeriod((ship:orbit:periapsis + targetStructure:apoapsis) / 2).
...
until angle - TRANSFERANGLE < 1 and angle - TRANSFERANGLE > -1{
    ...
    print angle + " - " + TRANSFERANGLE at (0, 20).
}.

lock throttle to 1.
print "fire".

until targetStructure:apoapsis - ship:orbit:apoapsis < 100000 or ship:orbit:hasnextpatch{
